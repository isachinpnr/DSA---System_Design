...
//  note : In a tree with n nodes -> n -1 edges...
...
// 3. Complete Binary Tree : All levels are completely filled except possibly the last level + last level
// must have it's keys as left as possible
...
// 4. Degenerate Tree : Parents node has expectly one child
...
// In a balanced binary tree, you can find an element or reach a leaf in $O(\log n)$ time,
